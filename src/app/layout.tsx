...
export const metadata: Metadata = {
  title: "ArtShop - Original Art & Contemporary Paintings",
  description: "Discover exceptional original artworks, contemporary paintings, and sculptures. Browse curated collections from emerging and established artists worldwide.",
  keywords: "art gallery, original paintings, contemporary art, sculptures, art collection, buy art online",
  metadataBase: new URL("https://artshop.gallery"),
  alternates: {
    canonical: "https://artshop.gallery"
  },
  openGraph: {
    title: "ArtShop - Original Art & Contemporary Paintings",
    description: "Discover exceptional original artworks, contemporary paintings, and sculptures from curated collections.",
    url: "https://artshop.gallery",
    siteName: "ArtShop",
    images: [
      {
        url: "https://images.pexels.com/photos/2559741/pexels-photo-2559741.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
        alt: "ArtShop Gallery Interior"
      }
    ],
    type: "website"
  },
  twitter: {
    ...
    title: "ArtShop - Original Art & Contemporary Paintings",
    description: "Discover exceptional original artworks from curated collections.",
    images: ["https://images.pexels.com/photos/2559741/pexels-photo-2559741.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"]
  },
  robots: {
    index: true,
    follow: true
